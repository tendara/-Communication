...
size_t village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__size_function__SellNovel_Response__novel(
...
const void * village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__get_const_function__SellNovel_Response__novel(
...
void * village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__get_function__SellNovel_Response__novel(
...
void village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__fetch_function__SellNovel_Response__novel(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const rosidl_runtime_c__String * item =
    ((const rosidl_runtime_c__String *)
    village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__get_const_function__SellNovel_Response__novel(untyped_member, index));
  rosidl_runtime_c__String * value =
    (rosidl_runtime_c__String *)(untyped_value);
  *value = *item;
}

void village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__assign_function__SellNovel_Response__novel(
  void * untyped_member, size_t index, const void * untyped_value)
{
  rosidl_runtime_c__String * item =
    ((rosidl_runtime_c__String *)
    village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__get_function__SellNovel_Response__novel(untyped_member, index));
  const rosidl_runtime_c__String * value =
    (const rosidl_runtime_c__String *)(untyped_value);
  *item = *value;
}

bool village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__resize_function__SellNovel_Response__novel(
...
static rosidl_typesupport_introspection_c__MessageMember village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__SellNovel_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(village_interfaces__srv__SellNovel_Response, novel),  // bytes offset in struct
    NULL,  // default value
    village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__size_function__SellNovel_Response__novel,  // size() function pointer
    village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__get_const_function__SellNovel_Response__novel,  // get_const(index) function pointer
    village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__get_function__SellNovel_Response__novel,  // get(index) function pointer
    village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__fetch_function__SellNovel_Response__novel,  // fetch(index, &value) function pointer
    village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__assign_function__SellNovel_Response__novel,  // assign(index, value) function pointer
    village_interfaces__srv__SellNovel_Response__rosidl_typesupport_introspection_c__resize_function__SellNovel_Response__novel  // resize(index) function pointer
  }
};
