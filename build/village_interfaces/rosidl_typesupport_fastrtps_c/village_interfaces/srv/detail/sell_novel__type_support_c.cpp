...
#include "rosidl_runtime_c/string.h"  // novel
#include "rosidl_runtime_c/string_functions.h"  // novel
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: novel
  {
    size_t size = ros_message->novel.size;
    auto array_ptr = ros_message->novel.data;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: novel
  {
    ...
    if (ros_message->novel.data) {
      rosidl_runtime_c__String__Sequence__fini(&ros_message->novel);
    }
    if (!rosidl_runtime_c__String__Sequence__init(&ros_message->novel, size)) {
      fprintf(stderr, "failed to create array for field 'novel'");
      return false;
    }
    auto array_ptr = ros_message->novel.data;
    for (size_t i = 0; i < size; ++i) {
      ...
      bool succeeded = rosidl_runtime_c__String__assign(
        ...
        tmp.c_str());
      if (!succeeded) {
        fprintf(stderr, "failed to assign string into field 'novel'\n");
        return false;
      }
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name novel
  {
    size_t array_size = ros_message->novel.size;
    auto array_ptr = ros_message->novel.data;
