  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = village_interfaces::srv::BorrowMoney_Request;
    is_plain =
      (
...
static size_t _BorrowMoney_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BorrowMoney_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = village_interfaces::srv::BorrowMoney_Response;
    is_plain =
      (
      offsetof(DataType, money) +
      last_member_size
...
static size_t _BorrowMoney_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BorrowMoney_Response(full_bounded, is_plain, 0);
