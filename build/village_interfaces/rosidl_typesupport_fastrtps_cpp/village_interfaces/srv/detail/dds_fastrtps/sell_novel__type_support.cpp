  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = village_interfaces::srv::SellNovel_Request;
    is_plain =
      (
...
static size_t _SellNovel_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SellNovel_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  // Member: novel
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.novel[index].size() + 1);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = village_interfaces::srv::SellNovel_Response;
    is_plain =
      (
...
static size_t _SellNovel_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SellNovel_Response(full_bounded, is_plain, 0);
